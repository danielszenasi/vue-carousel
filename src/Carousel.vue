  ...
  computed: {
    ...
    pageCount() {
      return this.scrollPerPage
        ? Math.ceil(this.slideCount / (this.currentPerPage - 2))
        : this.slideCount - 2;
    },
    /**
  ...
  methods: {
    ...
    goToPage(page) {
      if (page >= 0 && page <= this.pageCount) {
        this.offset = this.scrollPerPage
          ? Math.min(
              this.slideWidth * (this.currentPerPage - 2) * page,
              this.maxOffset
            )
    ...
    onEnd(e) {
      ...
      if (
        ...
        const width = this.scrollPerPage ? this.slideWidth : this.slideWidth;
    ...
    render() {
      ...
      const width = this.scrollPerPage
        ? this.slideWidth * (this.currentPerPage - 2)
        : this.slideWidth;
      ...
      this.currentPage = this.scrollPerPage
        ? Math.round(this.offset / this.slideWidth / (this.currentPerPage - 2))
