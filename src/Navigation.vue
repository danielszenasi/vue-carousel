...
.VueCarousel-navigation-next {
  ...
  font-family: "system";
  background: linear-gradient(to left, rgba(30, 30, 28, 1) 0%,rgba(30, 30, 28, 1) 50%,rgba(30, 30, 28,0) 100%);
...
.VueCarousel-navigation-prev {
  ...
  transform: translateY(-50%) translateX(-100%);
  font-family: "system";
  background: linear-gradient(to right, rgba(30, 30, 28, 1) 0%,rgba(30, 30, 28, 1) 50%,rgba(30, 30, 28,0) 100%);
